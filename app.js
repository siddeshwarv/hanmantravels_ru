...
const i18n = {
  ru: {
    ...
    reason2Desc: "Hanman Travels — лицензированное правительством Индии агентство (RA# RA5501045). Согласно правилам МИД Индии, сбор за оформление регламентирован и полностью покрывает наши расходы.",
  ...
  en: {
    ...
    reason2Desc: "Hanman Travels is a Govt.-Licensed Agency (RA# RA5501045). Under Ministry of External Affairs regulations, candidate service fees cover operational costs transparently.",
